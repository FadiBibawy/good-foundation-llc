  ...
  return (
    <div className="w-full py-10 bg-gray-200">
      <div className="relative flex flex-col px-5 mx-auto space-y-5 md:w-3/4">
        <div className="flex flex-col w-100 items-center justify-center mx-auto space-y-5 md:w-4/5">
          ...
          <div className=" flex flex-row flex-wrap w-100 items-center justify-center space-x-5 text-sm">
            <h6 className="font-bold mb-0">Michael Zekry</h6>
            <span className="text-xl font-extrabold text-blue-600">/</span>
            <p className=" mb-0">Founder & CEO of Good Foundation LLC.</p>
          </div>
        </div>
      </div>
    </div>
